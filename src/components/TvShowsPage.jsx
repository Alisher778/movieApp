...
const url =
	"https://api.themoviedb.org/3/tv/popular?api_key=c93f9215f2085cf5f8aa18a05afa9861";
...
class TvShowsPage extends Component {
	...
	goToPage(e) {
		...
		e.preventDefault();
		axios(
			`https://api.themoviedb.org/3/tv/popular?api_key=c93f9215f2085cf5f8aa18a05afa9861&page=${
